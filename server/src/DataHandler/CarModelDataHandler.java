...
public class CarModelDataHandler implements IObjectService {
    ...
    public CarModelDataHandler(int countUser, Socket socket, Database database, ObjectInputStream messageFromClient, ObjectOutputStream writeMessage) {
    ...
    @Override
    public LinkedList<CarModelView> showAll()
    {
        return database.SelectAllModel();
    }
